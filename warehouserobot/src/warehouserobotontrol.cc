...
WarehouserobotControl::WarehouserobotControl(){
...
void
WarehouserobotControl::Load(ModelPtr model, sdf::ElementPtr _sdf){
...
void
WarehouserobotControl::Init(çwarehouserobotSensors *sensors){
    ...
    updateConnection = gazebo::event::Events::ConnectWorldUpdateBegin(
        boost::bind(&WarehouserobotControl::OnUpdate, this, _1));
}

void
WarehouserobotControl::OnUpdate(const gazebo::common::UpdateInfo & /*_info*/){
...
void
WarehouserobotControl::teleport(gazebo::math::Pose pose){
